  ...
  function dossier() {
    ...
    const D = {
      ...
      4: { layer: "phy", phase: "Transito · Livello Fisico (OSI 1)",
           title: "Dal frame ai bit",
           fields: [["Unità (PDU)", "bit"], ["Mezzo", "rame · fibra · radio"], ["Segnale", "tensione · luce · onde"]],
           proto: "Livello Fisico: cavo/RJ45 · fibra · Wi-Fi · segnali",
           note: "Nessun header da aggiungere: il <b>livello fisico</b> trasforma il frame in <b>bit</b> (0 e 1) e poi in <b>segnali</b> — tensione sul rame, luce nella fibra, onde radio — che corrono sul cavo fino al server (vedi i bit sul cavo). Definisce cavi, voltaggi e velocità." },
